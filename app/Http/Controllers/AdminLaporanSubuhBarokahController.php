<?php namespace App\Http\Controllers;
	...
	class AdminLaporanSubuhBarokahController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "kas_masuk";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"Jenis Donasi Id","name"=>"jenis_donasi_id","join"=>"jenis_donasi,nama_jenis"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Jenis Donasi Id','name'=>'jenis_donasi_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'jenis_donasi,nama_jenis'];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Jenis Donasi Id","name"=>"jenis_donasi_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"jenis_donasi,nama_jenis"];
	    ...
	    */
		...
		public function getLaporanSubuhBarokah(){
			if (!CRUDBooster::isView()) CRUDBooster::redirect(CRUDBooster::adminPath(), trans('crudbooster.denied_access'));
			
			$data['page_title'] = 'Laporan Subuh Barokah';

			return $this->view('laporan/laporan-subuh-barokah', $data);
		}
	}