<?php namespace App\Http\Controllers;
	...
	class AdminKasKeluarKematianController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "kas_keluar_kematian";
			...
			$this->form[] = ['label'=>'Keperluan','name'=>'keperluan','type'=>'textarea','validation'=>'required','width'=>'col-sm-10'];
